...
class CurryConcat {
    ...
    public static String calc(String str1, String str2, String str3, String str4) {
        ...
        Function<String, Function<String, Function<String, Function<String, String>>>> stringFun = s1 -> s2 -> s3 -> s4 -> s1.toLowerCase() + s3.toUpperCase() + s2.toLowerCase() + s4.toUpperCase();
