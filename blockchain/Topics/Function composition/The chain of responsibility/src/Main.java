...
class ChainOfResponsibilityDemo {
     ...
     */
    static RequestHandler commonRequestHandler = wrapInTransactionTag.compose(createDigest).compose(wrapInRequestTag);/// !!! write a combination of existing handlers here
    ...
    interface RequestHandler {
        ...
        default RequestHandler compose(RequestHandler r2) {
            return req -> r2.handle(this.handle(req));
        }
    }
